...
const permissions = [
  { id: "viewBranches", label: "View Branches" },
  { id: "manageBranches", label: "Manage Branches" },
  ...
  { id: "viewExchangeRates", label: "View Exchange Rates" },
  { id: "manageExchangeRates", label: "Manage Exchange Rates" },
  { id: "viewAds", label: "View Ads" },
  { id: "manageAds", label: "Manage Ads" },
...
export default function RolesPage() {
  ...
  const onSubmit = async (data: any) => {
    try {
      const response = await fetch('/api/bank/roles', {
        method: 'POST',
        headers: {
